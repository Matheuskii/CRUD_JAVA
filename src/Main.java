...
public class Main {
    ...
    private static LocalDate verificadorData(String nascimento) {
        ...
        while(true) {
            ...
            if(nascimentoCerto.isBefore(dataAtual)){
                System.out.println("Não pode ser no futuro bobao");
            }
